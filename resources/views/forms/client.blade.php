<div class="p-5">
    <form action="{{isset($route)?$route:route('clients.store')}}" method="POST" >
    {{csrf_field()}}
...
<div class="form-group">
  ...
  @endif
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control {{ $errors->has('picture') ? ' is-invalid' : '' }}" name="picture" id="picture" value="{{old('picture',$model->picture)}}" placeholder="" maxlength="191" required="required" >
